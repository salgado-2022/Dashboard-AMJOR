    ...
    return (
        <>
            ...
            <Container >
                ...
                <Card>
                    <UserListToolbar numSelected={selected.length} filterName={filterName} onFilterName={handleFilterByName} placeholder="Buscar Insumo..." />
                                    ...
                                    {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                                        ...
                                        return (
                                            ...
                                            <TableRow hover key={ID_Insumo} tabIndex={-1} role="checkbox" selected={selectedUser}>
                                                ...
                                                <TableCell align="left">
                                                    <IconButton size="large" color="inherit" onClick={(event) => handleOpenMenu(event, ID_Insumo)} >
                                                ...
                                                >
                                                    <MenuItem onClick={() => handleEditar(selectedInsumo)}>
            ...
            <EditInsumo
                ...
                selectedInsumoID={selectedInsumo}
            />
            <AddInsumo
                show={modalShowNew}
