                                    ...
                                    {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                                        ...
                                        return (
                                            ...
                                            <TableRow hover key={ID_Ancheta} tabIndex={-1} role="checkbox" selected={selectedUser}>
                                                ...
                                                <TableCell align="left">
                                                    <IconButton size="large" color="inherit" onClick={(event) => handleOpenMenu(event, ID_Ancheta)} >
                                                ...
                                                >
                                                    <MenuItem
                                                        onClick={() => handleDetalle(selectedAncheta)}>
                                                    ...
                                                    <MenuItem
                                                        ...
                                                        onClick={() => handleEditar(selectedAncheta)}>
                                                    ...
                                                    <MenuItem
                                                        sx={{ color: 'error.main' }}
                                                        onClick={() => handleDelete(selectedAncheta)}
                                                    >
